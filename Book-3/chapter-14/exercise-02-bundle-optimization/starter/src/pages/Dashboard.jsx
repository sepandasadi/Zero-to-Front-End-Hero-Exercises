// ❌ BAD: Importing heavy chart library (200KB) that's only used on this page
...
function Dashboard() {
  return (
    <div className="container">
      <h1>
        Analytics Dashboard
        <span className="badge">recharts: 200KB in main bundle</span>
      </h1>
      ...
      <p style={{ marginTop: '20px', color: '#666' }}>
        ⚠️ This page loads 200KB of chart libraries even though most users never visit it!
      </p>
    </div>
  );
}
